...
export const authReducer = createReducer(initialState, (builder) => {
  builder
    ...
    .addCase(avatarUpload.pending, (state, { payload }) => {
      state.isPending = true;
      state.error = undefined;
    })
    .addCase(avatarUpload.rejected, (state, { error }) => {
      state.isPending = false;
      state.error = error.message;
    })
    .addCase(avatarUpload.fulfilled, (state, { payload }) => {
      state.isPending = false;
      state.userData = { ...state.userData, avatar: payload.path };
    })
